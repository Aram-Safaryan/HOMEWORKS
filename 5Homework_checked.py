...
# x = int(input())  # Այս մոտեցումը հարմար չէ, եթե գործ ունենք ավելի շատ input-ների հետ։ Կարող ենք ցիկլ օգտագործել։
# y = int(input())
# z = int(input())
# m = int(input())
# n = int(input())
...
#        print('True')
#        Մեզ միայն մի անգամ է պետք տեսնել True։ Եթե մի քանի անգամ տվյալ պայմանը բավարարվի, շատ True-եր կտպվեն։
#        Կարող ենք flag օգտագործել, որը True կդառնա, եթե պայմանը բավարարվում է ու վերջում կտպենք այն։
...
if lst == lst1:
   ...
   print ('False')  # Պետք չի մի տեղ սթրինգ օգտագործել մի տեղ բուլեան։ Նույն նպատակի համար նույն տիպը պետք է օգտագործենք
...
for i in [1,15]:  # 1-15 բոլոր թվերը պետք է լինեն։ Ամենահեշտ տարբերակը dictionary comprehension-ն է
    key = i
for j in [1,225]:
    value = j
